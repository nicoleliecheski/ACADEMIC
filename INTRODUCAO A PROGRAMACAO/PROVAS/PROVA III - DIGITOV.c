...
int main() {
    ...
    if((UF > 28)||(UF < 1)){
        ...
        dig[0] = (numSeq - numSeq%10000000)/10000000;
        dig[1] = (numSeq%10000000 - numSeq%1000000)/1000000;
        dig[2] = (numSeq%1000000 - numSeq%100000)/100000;
        dig[3] = (numSeq%100000 - numSeq%10000)/10000;
        dig[4] = (numSeq%10000 - numSeq%1000)/1000;
        dig[5] = (numSeq%1000 - numSeq%100)/100;
        dig[6] = (numSeq%100 - numSeq%10)/10;
        dig[7] = numSeq%10;
        /*for(i = 0; i < 8; i++){
            printf("%ld ", dig[i]);
        }*/
